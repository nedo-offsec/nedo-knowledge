...
Если колбэк паникует, флаг done НЕ устанавливается в 1.
Поэтому при следующем вызове Do() функция выполнится снова.
Это сделано специально, чтобы дать шанс восстановиться.
